...
export const getTasksPaneSearchKeywords = createLocalizedCatalog(() => [
  ...
  ...translateSearchKeyword('auto.components.settings.tasks.search.releaseMerge', 'release merge'),
  ...translateSearchKeyword('auto.components.settings.tasks.search.hisMerge', 'his merge'),
  ...translateSearchKeyword('auto.components.settings.tasks.search.dfhis', 'dfhis'),
  ...translateSearchKeyword('auto.components.settings.tasks.search.aliyun', 'aliyun'),
