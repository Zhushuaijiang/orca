...
import { useTaskPageYunxiaoActions } from '@/components/task-page/hooks/use-task-page-yunxiao-actions'
...
export default function TaskPage(): React.JSX.Element {
  ...
  return (
    <TaskPageLayout
      ...
      yunxiaoList={{ onStartWorkspace: handleUseYunxiaoItem }}
      codeMergeWorkspace={{ onOpenCodeMergeComposer: openComposerForCodeMerge }}
