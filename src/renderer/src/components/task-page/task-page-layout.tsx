...
export type TaskPageYunxiaoListProps = {
  onStartWorkspace: (item: YunxiaoWorkItem) => void
}

export type TaskPageCodeMergeWorkspaceProps = {
...
export function TaskPageLayout({
  ...
  yunxiaoList: TaskPageYunxiaoListProps
  codeMergeWorkspace: TaskPageCodeMergeWorkspaceProps
      ...
      <div className="relative flex min-h-0 min-w-0 flex-1 flex-col">
        ...
        <div className="mx-auto flex min-h-0 min-w-0 w-full flex-1 flex-col px-5 pt-1.5 pb-4 md:px-8 md:pt-1.5 md:pb-5">
          ...
          {taskSource === 'github' && githubDetail ? (
            ...
            <TaskPageCodeMergeWorkspace {...codeMergeWorkspace} />
          ) : taskSource === 'yunxiao' ? (
            <TaskPageYunxiaoWorkItemList {...yunxiaoList} />
          ) : null}
        </div>
      </div>
