    ...
    <>
      ...
      >
        <div className="flex min-w-0 flex-wrap items-center justify-between gap-3">
          ...
          >
            {gitlabView === 'issues' && onCreateGitLabIssue ? (
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    variant="outline"
                    size="icon"
                    onClick={onCreateGitLabIssue}
                ...
                <TooltipContent side="bottom" sideOffset={6}>
                  {translate('auto.components.TaskPage.c8604b1bf2', 'New GitLab issue')}
                </TooltipContent>
              </Tooltip>
            ) : null}
            <Tooltip>
