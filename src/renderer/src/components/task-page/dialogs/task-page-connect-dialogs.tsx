...
export type TaskPageConnectDialogsProps = {
  ...
  gitlabFilesDialogItem: GitLabWorkItem | null
  gitlabFilesDialogRepo: Repo | null
  gitlabFilesDialogSourceContext: TaskSourceContext | null
  setGitlabFilesDialogItem: (item: GitLabWorkItem | null) => void
