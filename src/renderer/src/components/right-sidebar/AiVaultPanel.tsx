...
import { useYunxiaoAugmentedSessions } from './ai-vault-yunxiao-search'
import {
...
export default function AiVaultPanel(): React.JSX.Element {
  ...
  // Yunxiao requirement-index hits merge into the scanned/searched list (they
  // live outside both); the shared yunxiao matcher re-filters them below.
  const searchedSessions = searching ? search.sessions : history
  const sessions = useYunxiaoAugmentedSessions(searchedSessions, scope, query)
