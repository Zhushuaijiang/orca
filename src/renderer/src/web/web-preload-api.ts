...
} from './preload-api/web-clipboard-api'
export { GITHUB_WEB_RPC_METHODS } from './preload-api/web-github-routes'
export { GITLAB_WEB_RPC_METHODS } from './preload-api/web-gitlab-routes'
import {
  createAccountsApi,
...
import { createYunxiaoApi } from './preload-api/web-yunxiao-api'
import { createDfHisEnvironmentApi } from './preload-api/web-dfhis-environment-api'
import {
...
function createWebPreloadApi(): Partial<PreloadApi> {
  return {
    ...
    dfhisEnvironment: createDfHisEnvironmentApi(),
    pty: createPtyApi(),
    ssh: createSshApi(),
    wsl: {
