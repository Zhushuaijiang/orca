...
import type { WorktreeCardMode, WorktreeCardProperty } from '../../../../shared/ui-chrome-types'
...
type NewWorkspaceDraftLinkedWorkItem = Omit<WorkspaceLinkedItem, 'provider'> & {
...
export type UISlice = {
  ...
  newWorkspaceDraft: {
    ...
    note: string
    attachments: string[]
    linkedWorkItem: NewWorkspaceDraftLinkedWorkItem | null
