...
// Fork-only: Yunxiao work-item/todo-pool lane, not present upstream.
...
// Fork-only: DFHIS environment bootstrap (prerequisite check + guided install).
export type DfHisEnvironmentApi = {
...
// Fork-only: finds and kills processes holding an agent session lock.
...
// Fork-only extension of upstream's AiVaultApi.
type AiVaultYunxiaoSearchApi = {
...
export type PreloadApi = {
  ...
  aiVault: Merged<AiVaultApi & AiVaultYunxiaoSearchApi>
