...
- Default low-risk work to one builder plus local verification. Escalate to focused review for unresolved decisions, UI/workflow, API/database, requirement conflict, weak verification, or explicit user review requests. Escalate to mandatory PRD/architecture/implementation/verifier review for multi-repo, permission/release, API/database plus weak verification, or UI/workflow plus requirement conflict cases. Preserve each reviewer verdict in reviewChecks and decide by evidence, not majority.
