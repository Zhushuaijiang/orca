...
export function buildYunxiaoTerminalEnv(
  ...
  addIfMissing(env, 'MAGIC_BASE_URL', config.magicApiBaseUrl)
  addIfMissing(env, 'MAGIC_USERNAME', config.magicApiUsername)
  addIfMissing(env, 'MAGIC_PASSWORD', config.magicApiPassword)
  addIfMissing(env, 'MAGIC_API_VERSION', config.magicApiVersion)
