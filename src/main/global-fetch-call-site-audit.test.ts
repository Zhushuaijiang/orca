...
const AUDITED_GLOBAL_FETCH_LINES = new Map<string, number>([
  ...
  ['main/dfhis-environment/remote-workflow-pack-installer.ts', 1],
  ['main/gitea/client.ts', 1],
  ['main/gitlab/issues.ts', 1],
  ...
  ['main/skill-contributions/channel-listener.ts', 1],
  ['main/skill-contributions/remote-pack-aggregates.ts', 1],
  ['main/skill-contributions/server-origin.ts', 1],
  ['main/skill-contributions/uploader.ts', 1],
  ['main/source-control/hosted-review-api-request.ts', 1],
  ['main/speech/openai-transcription-client.ts', 1],
  ['main/yunxiao/mcp-http-transport.ts', 1],
