...
import type { YunxiaoTodoPoolClaimOperations } from './yunxiao-todo-pool-claims'
...
export class AutomationPersistence {
  ...
  constructor(
    ...
    flushBarriers: WriteFlushBarrierOperations,
    preferences: ProfilePreferences,
    yunxiaoTodoPool: AutomationPersistenceContext['yunxiaoTodoPool']
  ) {
    this[automationPersistenceContext] = { runtime, flushBarriers, preferences, yunxiaoTodoPool }
  }
  ...
  setAutomationRunYunxiaoTodoPoolClaim(
    ...
    return setAutomationRunYunxiaoTodoPoolClaimOperation(
      getAutomationRunOperations(this),
      runId,
      claim,
      title
...
export function getAutomationRunOperations(owner: AutomationPersistence): AutomationRunOperations {
  return {
    ...
    applyYunxiaoRequirementGateOutcome: (args) =>
      owner[automationPersistenceContext].yunxiaoTodoPool.applyYunxiaoRequirementGateOutcome(args),
    updateYunxiaoTodoPoolClaimStatus: (args) =>
      owner[automationPersistenceContext].yunxiaoTodoPool.updateYunxiaoTodoPoolClaimStatus(args)
  }
}
