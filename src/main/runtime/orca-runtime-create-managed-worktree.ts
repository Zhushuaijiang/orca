...
import { createManualYunxiaoRequirementGate } from '../../shared/yunxiao-requirement-prompt-gate'
import type { ManualYunxiaoRequirementGate } from '../../shared/yunxiao-requirement-prompt-gate'
import { ensureDfHisWorkflowPackCurrentForPrompt } from './runtime-yunxiao-requirement-gate'
...
export class OrcaRuntimeWithCreateManagedWorktree extends OrcaRuntimeWithGetWorktreeTerminalProvisioningHost {
  ...
  private async performManagedWorktreeCreate(
    ...
    await ensureDfHisWorkflowPackCurrentForPrompt(
    ...
    const manualYunxiaoRequirementGate = [
      ...
      args.name,
      args.comment
    ].reduce<ManualYunxiaoRequirementGate | null>(
