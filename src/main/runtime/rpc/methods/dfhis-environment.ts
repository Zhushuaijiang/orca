...
const DfHisEnvironmentConfigInputSchema = z
  .object({
    ...
    hisFactCardsRoot: OptionalPlainString,
    hisFactIndexPath: OptionalPlainString,
    ygtWorkspaceRoot: OptionalPlainString,
    projectIndexManifestPath: OptionalPlainString,
